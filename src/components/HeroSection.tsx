    ...
    <section id="home" className="relative bg-gradient-to-br from-primary via-primary/95 to-primary/80 text-white py-20 overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-4xl mx-auto text-center space-y-6">
          ...
          <p className="text-xl text-white/90 max-w-2xl mx-auto animate-fade-in-up animation-delay-100">
          ...
          <div className="grid grid-cols-2 gap-6 pt-8 max-w-md mx-auto animate-fade-in-up animation-delay-300">
